...
stage to invert, which is why Tables 8–13 of Šešelj et al. (2019) have no
`Ac` row.

Such teeth are excluded from the estimate and reported separately as a
**reference completion threshold**, derived from the ages of attainment in
Tables 2–7:
...
sample's completion ages — a descriptive statistic, not a lower confidence
